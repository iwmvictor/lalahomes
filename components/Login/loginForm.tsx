        ...
        <Form {...loginForm}>
          ...
          >
            ...
            <div className="gap-10 flex-column">
              <div className="mt-5">
                <button className="bg-primary text-white p-2 rounded w-full hover:bg-blue-900 flex items-center justify-center gap-2">
                  <FcGoogle size={20} />
                  Sign In With Google
                </button>
              </div>
              <div>
                <button
                  className="w-full justify-center p-1 text-blue-900 hover:bg-blue-100"
